...
import com.taohansen.dscatalog.entities.PasswordRecover;
import com.taohansen.dscatalog.entities.User;
import com.taohansen.dscatalog.repositories.PasswordRecoverRepository;
...
public class AuthService {
    ...
    public void createRecoverToken(EmailDTO body) {
        ...
        String emailText = "<h1>Token: " + recoverUri + entity.getToken() + "</h1> " +
                           "<p> Token válido por " + tokenMinutes + " minutos</p>";
