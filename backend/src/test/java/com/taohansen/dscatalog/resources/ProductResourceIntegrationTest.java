...
public class ProductResourceIntegrationTest {
    ...
    public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
        ...
        ProductDTO productDTO = Factory.createProductDTO(EXPECTED_NAME);
        ...
        result.andExpect(jsonPath("$.name").value(EXPECTED_NAME));
        result.andExpect(jsonPath("$.description").exists());
    }

    @Test
    public void updateShouldNotFoundWhenIdNonExists() throws Exception {
